...
//***************************************************************************
ZilchDefineType(Physics2dPlugin, builder, type)
{
...
{
  Zilch::Console::WriteLine("Physics2dPlugin::Physics2dPlugin (Constructor)");
...
Physics2dPlugin::~Physics2dPlugin()
{
  Zilch::Console::WriteLine("Physics2dPlugin::~Physics2dPlugin (Destructor)");
  // Always check for null if you are intending
  // to destroy any cogs that you 'own'
}

//***************************************************************************
void Physics2dPlugin::Initialize(ZeroEngine::CogInitializer* initializer)
{
  Zilch::Console::WriteLine("Physics2dPlugin::Initialize");
  
  ZeroConnectThisTo(this->GetSpace(), "LogicUpdate", "OnLogicUpdate");
}

//***************************************************************************
void Physics2dPlugin::OnLogicUpdate(ZeroEngine::UpdateEvent* event)
{
  ...
  Zilch::HandleOf<Physics2dPluginEvent> toSend = ZilchAllocate(Physics2dPluginEvent);
  toSend->mLives = mLives;
  this->GetOwner()->DispatchEvent("Physics2dPluginUpdate", toSend);
}

//***************************************************************************
Zilch::String Physics2dPlugin::Speak()
{
...
//***************************************************************************
float Physics2dPlugin::GetHealth()
{
  return mHealth;
}

//***************************************************************************
void Physics2dPlugin::SetHealth(float value)
{
  if (value < 0)
    value = 0;
  else if (value > 100)
...
//***************************************************************************
ZilchDefineType(Physics2dPluginEvent, builder, type)
{
